...
public class ProductMain {
    public static void main(String[] args) {
        ...
        //클래스명.메서드명()   --Array.toString(); 과 유사하게 클래스로 바로 호출
