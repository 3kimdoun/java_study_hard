...
public class Main {
    public static void main(String[] args) {
        //추상 클래스는 객체 생성이 불가능하다고 함
//        Factory factory1 = new Factory("임시공장") {
//            @Override
//            public void produce(String model) {
//                System.out.println(this.getName()+"에서 [ "+model + " ]를 생산합니다.");
//            }
//
//            @Override
//            public void manage() {
//                System.out.println( this.getName() + "에서 야근중입니다");
//
//            }
//        };
...
//        factory1.manage();
        ...
        //근데 이상의 개념은 익명 클래스로 자바 17 (11일스도) 에 적용됨
        // 재사용하지 않고 한 번만 사용하고 치울 예정이라면 사용하기 좋음

        // 슈퍼 클래스의 추상메서드를 각 서브 클래스들이 구현부를 작성해 호출한 예씨
        ...
        tabletFactory1.produce("아이패드 8세대 ");

        //슈퍼 클래스의 일반 메서드를 서브클래스에서 호출한 예시 -> @Override 를 안 해도 사용가능하다는 점에 주목해야 함
